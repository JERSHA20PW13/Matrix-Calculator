...
DiagonalMatrix :: DiagonalMatrix() : SquareMatrix()
{

}

DiagonalMatrix :: DiagonalMatrix(int n) : SquareMatrix(n)
{
...
DiagonalMatrix::DiagonalMatrix(const Matrix& m)
{
    row = m.getRow();
    col = m.getColumn();
    pp = new double *[row];
...
DiagonalMatrix DiagonalMatrix::operator =(Matrix& m)
{
    row = m.getRow();
    col = m.getColumn();
    pp = new double *[row];
